...
void gx_gui_create_window_and_surface(gx_liquiddriveUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_liquiddriveUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_liquiddriveUI *ui) {
	...
	UnregisterClass(TEXT("gx_liquiddriveUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_liquiddriveUI *ui = (gx_liquiddriveUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
